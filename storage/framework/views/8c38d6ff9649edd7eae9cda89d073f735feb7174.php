    ...
    <div class="row">
        <div class="col-lg-6">
			<div class="card-box">
                ...
                <?php echo Form::model($transaksi, ['method' => 'PATCH', 'route' => ['admin.debitur.transaksi.update', $debitur->id, $transaksi->id], 'class' => 'form-horizontal']); ?>

                
                    <div class="form-group <?php if($errors->first('kode')): ?> has-error <?php endif; ?>">
	            	    <?php echo Form::label('kode', 'Kode Transaksi.*'); ?>

	            	    <?php echo Form::text('kode', null, ['class' => 'form-control', 'required' => 'required', 'readonly' => 'readonly', 'data-parsley-id' => 1, 'parsley-trigegr' => 'change']); ?>

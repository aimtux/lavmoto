    ...
    <div class="row">
        <div class="col-lg-6">
			<div class="card-box">
                ...
                <?php echo Form::model($debitur, ['method' => 'PATCH', 'url' => ['admin/debitur', $debitur->id], 'class' => 'form-horizontal']); ?>
	            	...
	            	<div class="form-group">
        				...
        				<div class="input-group">
							<input type="text" name="tgl_lahir" class="form-control" placeholder="tahun-bulan-tanggal" id="datepicker-autoclose" value="<?php echo e($debitur->tgl_lahir); ?>">
